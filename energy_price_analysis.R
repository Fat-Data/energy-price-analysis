...
# Figure2
ggplot(survey2, aes(x=price..euro.mwh.,y=value, color=variable)) + geom_boxplot() + facet_grid(~variable)

# Figure3
ggplot(survey4, aes(x=price..euro.mwh.,y=value, color=variable)) + geom_boxplot() + facet_grid(~variable)
